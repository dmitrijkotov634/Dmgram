                ...
                if (currentDialogFolderId == 0) {
                    if (chat != null) {
                        if (chat.scam) {
                            ...
                            drawVerified = chat.verified || Arrays.asList(BuildVars.VERIFIED).contains(chat.username);
                        }
                    } else if (user != null) {
                        if (user.scam) {
                            drawScam = 1;
                            ...
                            drawVerified = user.verified || Arrays.asList(BuildVars.VERIFIED).contains(user.username);
                        }
